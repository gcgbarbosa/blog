...
```text
=== wikidata ===
* Merge[ResourceLoader|dependencies=mediawiki.api,oojs-ui,mediawiki.util,mediawiki.language,oojs-ui-windows,wikibase,wikibase.sites|rights=edit,item-merge,item-redirect|namespaces=0,120]|Merge.js
```
