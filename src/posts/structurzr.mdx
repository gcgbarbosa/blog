...
Then open [http://localhost:8080/workspace/diagrams](http://localhost:8080/workspace/diagrams)
...
Download the `structurizr-cli.zip` from [https://github.com/structurizr/cli/releases](https://github.com/structurizr/cli/releases).
